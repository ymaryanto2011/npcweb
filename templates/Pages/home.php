...
$checkConnection = function (string $name) {
    ...
    try {
        ...
        // Removed getAttributes() call to avoid undefined method error
        if ($name === 'debug_kit') {
...
<body>
    ...
    <section class="hero-section py-5 bg-light">
        <div class="container text-center">
            <h1 class="display-4 mb-3">Selamat Datang di Portal Berita NPCI Kabupaten</h1>
            <p class="lead mb-4">Informasi terbaru seputar NPCI, atlet, dan kegiatan kabupaten.</p>
            <a href="<?= $this->Url->build('/news/artikel') ?>" class="btn btn-primary btn-lg">Lihat Berita Terbaru</a>
        </div>
    </section>
    ...
    <section class="latest-news py-5">
        <div class="container">
            ...
            <div class="row">
                <!-- Contoh berita statis, nanti bisa diganti dengan data dinamis -->
                <div class="col-md-4 mb-4">
                    <div class="card h-100">
                        <img src="/newsportal/img/news1.jpg" class="card-img-top" alt="Berita 1">
                        <div class="card-body">
    ...
    <div class="container-fluid">
        <!-- ...copy bagian main news slider dari template BizNews... -->
    </div>
    <!-- Main News Slider End -->

    <!-- Breaking News Start -->
    <div class="container-fluid bg-dark py-3 mb-3">
        <!-- ...copy bagian breaking news dari template BizNews... -->
    </div>
    <!-- Breaking News End -->

    <!-- Featured News Slider Start -->
    <div class="container-fluid pt-5 mb-3">
        <!-- ...copy bagian featured news dari template BizNews... -->
    </div>
    <!-- Featured News Slider End -->

    <!-- News With Sidebar Start -->
    <div class="container-fluid">
        <!-- ...copy bagian news with sidebar dari template BizNews... -->
    </div>
